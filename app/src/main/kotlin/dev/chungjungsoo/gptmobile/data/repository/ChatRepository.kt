...
interface ChatRepository {
    ...
    suspend fun completeOpenAIChat(question: Message, history: List<Message>, systemPrompt: String? = null, model: String? = null): Flow<ApiState>
    suspend fun completeAnthropicChat(question: Message, history: List<Message>, systemPrompt: String? = null, model: String? = null): Flow<ApiState>
